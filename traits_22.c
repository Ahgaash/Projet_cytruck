...
if(racine ==NULL){
printf("L'arbre en entré est vide");
return 1;}
...
int trierTableau(Trajet *tableau, int taille) {
	if(tableau == NULL){
	printf("le tableau en entré est vide");
	return 1;}
    Trajet temp;
    int trie = 0;
...
int inverserTableau(Trajet tableau[], int taille) {
	if(tableau == NULL){
	printf("le tableau en entré est vide");
	return 1;}
    int debut = 0;
