...
if(choix==1){
    ...
    while (fscanf(fichier, "%d;%99[^\n]\n", &stepvilles, ville) == 2){ //problème avec la récupération des données 
 ...
 // for(int i = 0; i < 10; i++) {
  //  printf("%s nbre de passage (%d) nbr de départ : (%d) \n", top10Array[i].nom, top10Array[i].nombreTrajets,top10Array[i].depart);}
